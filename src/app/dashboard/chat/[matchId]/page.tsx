 ...
 useEffect(() => {
  ...
  useEffect(() => {
    ...
    const fetchMessages = async () => {
      ...
      if (!error && data && userId) await markMessagesAsRead(matchId as string, userId)
      setLoading(false)
    }
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-50">
      ...
      <div className="p-4 bg-white border-t flex gap-2">
        ...
        <button
          onClick={sendMessage}
          className="bg-blue-500 text-white rounded-full px-5 py-2 text-sm font-medium hover:bg-blue-600 transition"
        >
          Senden
        </button>
      </div>
